...
const About = () => {
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-800 dark:text-white py-16 px-4 md:px-20 mt-10">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg md:text-xl leading-relaxed mt-6">
          I enjoy solving real-world problems through code and continuously strive to improve my skills. Currently, I’m looking for Iternship opportunity in Full Stack Development and, I am actively working on personal projects to sharpen my practical knowledge.
        </p>
